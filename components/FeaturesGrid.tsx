...
const features = [
  ...
  },
  {
    ...
    background: (
      <FollowupList className="absolute right-2 top-4 h-[300px] w-full border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105" />
    ),
  },
  {
    Icon: Share2Icon,
  ...
  },
  {
    ...
    className: "col-span-3 md:col-span-1",
    background: (
      <CustomerJourney className="absolute right-2 top-4 h-[300px] w-full border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105" />
    ),
  },
  {
    Icon: ChartSpline,
    ...
    className: "col-span-3 md:col-span-2",
    background: (
      <PredictiveAnalytics className="absolute right-2 top-4 h-[300px] w-full border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105" />
    ),
  },
];
